...
describe("LatentMapViewer", () => {
  it("renders directly as a map surface with prototype fixture data", () => {
    ...
    expect(html).toContain("data-runtime-preview-texture-budget=\"0\"");
    expect(html).toContain("data-runtime-preview-texture-bytes=\"0\"");
    expect(html).toContain("data-runtime-preview-texture-count=\"0\"");
    expect(html).toContain("data-runtime-preview-texture-failed=\"0\"");
    expect(html).toContain("data-runtime-preview-texture-loading=\"0\"");
