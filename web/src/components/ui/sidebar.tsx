    ...
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          ...
          open && "has-data-[variant=inset]:bg-sidebar",
          className
        )}
        {...props}
      >
