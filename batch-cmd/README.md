...
- `start-latent-map-j-shoot.command` starts this worktree against the J Shoot latent-map run, verifies the 32/64/96px atlases exist, and opens the real-data latent-map URL.
